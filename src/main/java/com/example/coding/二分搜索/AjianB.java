...
public class AjianB {
    public static void main(String[] args) throws IOException {
        IO sc=new IO();
        String qn[]=sc.getStrArr(" ");
        long n=Long.parseLong(qn[0]);
        long C=Long.parseLong(qn[1]);
        String s[]=sc.getStrArr(" ");
        ...
        long ans=0;
        for(int i=0;i<n;i++){
            ans+=map.get(arr[i])==null?0:map.get(arr[i]);
        }
